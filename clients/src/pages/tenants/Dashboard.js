...
export default function TenantDashboard() {
  ...
  const handleClaimCredit = async () => {
    try {
      ...
      toast.error(
        err.response?.data?.message || "Failed to claim referral credit."
      );
    }
  };
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <p className="text-gray-600 mb-4">
            View and share your favorite properties.
          </p>
          <Link
            to="/wishlist"
            className="text-blue-600 hover:underline font-medium">
          ...
          <button
            ...
            className="ml-4 bg-green-500 text-white px-4 py-2 rounded-md hover:bg-green-600 font-medium">
            Share Wishlist
          </button>
        </div>
        <div className="bg-white p-6 rounded-lg shadow-md">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <p className="text-gray-600 mb-4">
            Calculate your affordable rent based on your income.
          </p>
          <Link
            to="/tenant/rent-calculator"
            className="text-blue-600 hover:underline font-medium">
            Use Calculator
          </Link>
        </div>
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <p className="text-gray-600 mb-4">
            Get organized for your move with our comprehensive checklist.
          </p>
          <Link
            to="/tenant/moving-checklist"
            className="text-blue-600 hover:underline font-medium">
            View Checklist
          </Link>
        </div>
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <Link
            to="/tenant/roommate-questionnaire"
            className="text-blue-600 hover:underline font-medium">
            Create Profile
          </Link>
          <Link
            to="/tenant/roommate-matches"
